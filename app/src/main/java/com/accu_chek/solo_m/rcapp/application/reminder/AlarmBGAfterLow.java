...
public class AlarmBGAfterLow extends AlarmGeneral
{

    AlarmBGAfterLow(Context context, AlarmData data)
    {
        super(context, data);
	...
	int onChangeLayout() 
	{
		return EMWRList.EMW48317.getCodeId();
	}
