...
public class AlarmBGAfterHigh extends AlarmGeneral
{

    AlarmBGAfterHigh(Context context, AlarmData data)
    {
        super(context, data);
	...
	int onChangeLayout() 
	{
		return EMWRList.EMW48316.getCodeId();
	}
