...
public class AlarmLabTest extends AlarmFirstAlertOfDay
{

    AlarmLabTest(Context context, AlarmData data) 
    {
        super(context, data);
    }
	...
	int onChangeLayout() 
	{
		return EMWRList.EMW48320.getCodeId();
	}
