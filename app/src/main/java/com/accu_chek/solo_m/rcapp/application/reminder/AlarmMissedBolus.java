...
public class AlarmMissedBolus extends AlarmRepeat
{

    AlarmMissedBolus(Context context, AlarmData data)
    {
        super(context, data);
	...
	int onChangeLayout() 
	{
		return EMWRList.EMW48314.getCodeId();
	}
